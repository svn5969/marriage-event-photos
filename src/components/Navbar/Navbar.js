...
const NavBar = () => {
    return (
        ...
        <Navbar.Brand href="/home"><img style={{width: '80px',height:'45px',marginLeft:'100px'}} src={dark} alt="" /></Navbar.Brand>
        <Navbar.Toggle aria-controls="responsive-navbar-nav" />
        <Navbar.Collapse id="responsive-navbar-nav">

          <Nav  className="ml-auto ms-5 mr-auto">
          <Link smooth className="nav-link ms-5 px-4 text-white " to="#home">Home</Link>
                            ...
                            <Link smooth className="nav-link ms-5 px-4 text-white " to="#projects">Projects</Link>
